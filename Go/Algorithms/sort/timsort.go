...
func Timsort[T Ordered](data []T) []T {
...
func insertionSortRuns[T Ordered](data []T, runSize int) {
...
func mergeRuns[T Ordered](data []T, runSize int) {
...
func mergeRun[T Ordered](data []T, lower, mid, upper int) {
